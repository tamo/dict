...
* 特にディスク容量にお困りでなければ、とりあえず `SKK-JISYO.L+` をお使いになれば良
  いでしょう。
* SKK abbrev 変換で、英語 → 日本語な変換を多用したい人は、英和辞書 `SKK-JISYO.edict2` を
...
SKK 辞書の誤り、追加すべき候補、エントリを発見された方は
...
サイズが小さなものから順に、`SKK-JISYO.S`, `SKK-JISYO.L`, `SKK-JISYO.L+` があります。好みや必要に応じて、どれか一つをダウンロードしてお使いください。

単漢字主義のS辞書と語彙主義のL辞書とでは収録されている「語」の種類だけでなく登録順なども大きく異なっているので、どの辞書を使うかでほとんど別の input method と言って良いほど使用感が違うと思います。

  * SKK-JISYO.S.gz
    - [./SKK-JISYO.S.gz](./SKK-JISYO.S.gz)
      [[md5](./SKK-JISYO.S.gz.md5)]
  ...
  * SKK-JISYO.L+.gz
    - [./SKK-JISYO.L+.gz](./SKK-JISYO.L+.gz)
      [[md5](./SKK-JISYO.L+.gz.md5)]
    - L 辞書に[各種フィルター](https://github.com/tamo/dict/tree/abridged/filters)をかけたものです。痒いところに手が届くような工夫がされています。

  * SKK-JISYO.L.unannotated.gz
    - [./SKK-JISYO.L.unannotated.gz](./SKK-JISYO.L.unannotated.gz)
      [[md5](./SKK-JISYO.L.unannotated.gz.md5)]
...
`SKK-JISYO.L` 以上をお使いで、PC に余力がおありなら、各種の固有名詞を体系的に補う
...
### (1) 固有名詞系
  ...
  * SKK-JISYO.jinmei.gz
    - [./SKK-JISYO.jinmei.gz](./SKK-JISYO.jinmei.gz)
      [[md5](./SKK-JISYO.jinmei.gz.md5)]
  ...
  * SKK-JISYO.fullname.gz
    - [./SKK-JISYO.fullname.gz](./SKK-JISYO.fullname.gz)
      [[md5](./SKK-JISYO.fullname.gz.md5)]
  ...
  * SKK-JISYO.geo.gz
    - [./SKK-JISYO.geo.gz](./SKK-JISYO.geo.gz)
      [[md5](./SKK-JISYO.geo.gz.md5)]
  ...
  * SKK-JISYO.propernoun.gz
    - [./SKK-JISYO.propernoun.gz](./SKK-JISYO.propernoun.gz)
      [[md5](./SKK-JISYO.propernoun.gz.md5)]
  ...
  * SKK-JISYO.station.gz
    - [./SKK-JISYO.station.gz](./SKK-JISYO.station.gz)
      [[md5](./SKK-JISYO.station.gz.md5)]
...
### (2) 専門分野系
  ...
  * SKK-JISYO.law.gz
    - [./SKK-JISYO.law.gz](./SKK-JISYO.law.gz)
      [[md5](./SKK-JISYO.law.gz.md5)]
  ...
  * SKK-JISYO.okinawa.gz
    - [./SKK-JISYO.okinawa.gz](./SKK-JISYO.okinawa.gz)
      [[md5](./SKK-JISYO.okinawa.gz.md5)]
...
### (3) 特殊変換系
  ...
  * SKK-JISYO.assoc.gz
    - [./SKK-JISYO.assoc.gz](./SKK-JISYO.assoc.gz)
      [[md5](./SKK-JISYO.assoc.gz.md5)]
  ...
  * SKK-JISYO.edict2.gz
    - [./SKK-JISYO.edict2.gz](./SKK-JISYO.edict2.gz)
      [[md5](./SKK-JISYO.edict2.gz.md5)]
    - 英数文字を見出しにした変換 (abbrev) によって英和変換を実現するための辞書です。
    - [The Electronic Dictionary Research and Development Group](http://www.csse.monash.edu.au/groups/edrdg/) による「和英辞典」edict2u を SKK 辞書形式の「英和辞典」に加工したものです。
    - edict2 のライセンスは CC BY-SA 3.0 です。

  * zipcode.tar.gz
    - [./zipcode.tar.gz](./zipcode.tar.gz)
      [[md5](./zipcode.tar.gz.md5)]
...
特殊な入力方法や環境整備を必要とする辞書です。
  ...
  * SKK-JISYO.JIS2.gz
    - [./SKK-JISYO.JIS2.gz](./SKK-JISYO.JIS2.gz)
      [[md5](./SKK-JISYO.JIS2.gz.md5)]
    - この辞書は JIS 第二水準の文字のみを、部首を見出しとして収録した SKK 辞書です。
      `skk-tankan.el` と併用すると、部首と画数から検索できるようになります。

  * SKK-JISYO.itaiji.gz
    - [./SKK-JISYO.itaiji.gz](./SKK-JISYO.itaiji.gz)
  ...
  * SKK-JISYO.lisp.gz
    - [./SKK-JISYO.lisp.gz](./SKK-JISYO.lisp.gz)
      [[md5](./SKK-JISYO.lisp.gz.md5)]
...
書です。
  ...
  * SKK-JISYO.wrong.gz
    - [./SKK-JISYO.wrong.gz](./SKK-JISYO.wrong.gz)
      [[md5](./SKK-JISYO.wrong.gz.md5)]
    - `SKK-JISYO.{SML}` に間違えて含まれていたエントリを抽出したものです。
    - このファイルは `SKK-JISYO.{SL}` に再び誤ったエントリが含まれないようにする
      ための指標であり、また、個人辞書から誤ったエントリを削除するためのファイルで
      もあります。
    - 個人辞書から誤ったエントリを取り除くには、`skktools` を利用し、次のようにすれば良いでしょう。

      ```
      % skkdic-expr2 ~/.skk-jisyo - SKK-JISYO.wrong >.skk-jisyo.new
      ```
